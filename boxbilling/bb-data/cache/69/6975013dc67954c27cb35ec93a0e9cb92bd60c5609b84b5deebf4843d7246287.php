...
/* partial_menu.phtml */
class __TwigTemplate_9b07775a680da5967d450de6796886bba3c1e82962a6975c854d1edd6af10412 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/Library/WebServer/Documents/box_billing/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
